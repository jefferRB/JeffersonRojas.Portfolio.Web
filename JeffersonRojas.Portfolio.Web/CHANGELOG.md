...
- Cree un proyecto de Angular con ng: `ng new JeffersonRojas.Portfolio.Web --defaults --skip-install --skip-git --no-standalone `.
- Actualizar angular.json con puerto.
- Crear archivo de proyecto (`JeffersonRojas.Portfolio.Web.esproj`).
